!(function () {
  ...
  g &&
    ((W = (p.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      p.readyState
    )) ||
    ...
    St(r) &&
      ((y.transform =
        ...
        (b +=
          (v = void 0 !== g && g) && k
            ? "translate("
                .concat(u.x / gt - m / 2, "em, ")
                .concat(u.y / gt - p / 2, "em) ")
            : v
            ? "translate(calc(-50% + "
  ...
  function Ut(t) {
    return t.reduce(function (t, e) {
      ...
      if (Xt[e]) t.prefix = e;
        ...
        var a =
          "fa" === t.prefix ? Dt[n] || { prefix: null, iconName: null } : {};
    ...
    0 === n.length
      ...
      : (
          ...
          var t =
              !0 === V.autoReplaceSvg
                ? Qt.replace
                : Qt[V.autoReplaceSvg] || Qt.replace,
            e = Tt.begin("mutate");
          n.map(t), e(), a();
        });
  }
  ...
  function re(t) {
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix &&
          1 === i.length &&
          (o.iconName = Wt(o.prefix, ae(t.innerText))),
      o
    );
  }
  var ie = function (t) {
      ...
      children: [
        fe,
        {
          ...
          children: [
            ...
            {
              tag: "animate",
              attributes: B({}, ue, { values: "1;0;1;1;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: B({}, ue, { values: "1;0;0;0;0;1;" }),
            },
          ],
        },
        {
          ...
          children: [
            {
              tag: "animate",
              attributes: B({}, ue, { values: "0;0;1;1;0;0;" }),
            },
          ],
        },
      ],
  ...
  function ke(r) {
    if (g)
      return new pt(function (t, e) {
        var n = xt(r.querySelectorAll("*")).filter(xe).map(we),
