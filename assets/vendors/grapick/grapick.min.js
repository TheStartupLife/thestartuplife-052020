            ...
            s(t, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (
                    (!this.sandEl &&
                      (this.sandEl = document.createElement("div")),
                    !n || !i)
                  )
                    return "";
                  for (
                    var o = this.sandEl.style,
                      a = [i].concat(r(this.getPrefixedValues(e, t))),
                      l = void 0,
                      s = 0;
                    s < a.length &&
                    ((l = a[s]),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  e &&
                    (e.style.backgroundImage = this.getSafeValue(
                      "linear",
                      "to right"
                    ));
                },
                  ...
                  r &&
                    (0, f.on)(r, "click", function (t) {
                      ...
                      if (!((o = (l / a.w) * 100) > i || o < n)) {
                        ...
                        var d = c.getContext("2d").getImageData(l, s, 1, 1)
                            .data,
                          f =
                            "rgba(" +
                            d[0] +
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    ...
                    !e.silent && this.emit("handler:remove", i),
                    i
                  );
                },
              },
