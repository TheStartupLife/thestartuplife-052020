  ...
  (jQuery.mbYTPlayer = {
    ...
    play: function () {
      ...
      a.player.playVideo(),
        ...
        a.wrapper.css({ backgroundImage: "none" }),
    ...
    toggleVolume: function () {
      ...
      return a
        ? (a.isMute
            ? (jQuery.mbBrowser.mobile || this.YTPSetVolume(a.opt.vol),
              this.YTPUnmute())
            : this.YTPMute(),
          this)
        : this;
          ...
          if (
            ...
            if (
              ...
              (YTPStart.time = YTPlayer.currentTime),
                ...
                "mac" == jQuery.mbBrowser.os.name && jQuery.mbBrowser.safari
                  ? setTimeout(function () {
                      $YTPlayer.YTPPlay();
                    }, 10)
                  : $YTPlayer.YTPPlay();
