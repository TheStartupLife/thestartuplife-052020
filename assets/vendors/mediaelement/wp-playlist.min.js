!(function (a, b, c) {
  ...
  var e = c.View.extend({
    initialize: function (d) {
      (this.index = 0),
        ...
        (this.data =
          d.metadata ||
          a.parseJSON(this.$("script.wp-playlist-script").html())),
        (this.playerNode = this.$(this.data.type)),
        (this.tracks = new c.Collection(this.data.tracks)),
        ...
        b.isUndefined(window._wpmejsSettings) ||
          (this.settings = b.clone(_wpmejsSettings)),
    ...
    renderCurrent: function () {
      var a,
        b = "wp-includes/images/media/video.png";
      "video" === this.data.type
        ? (this.data.images &&
            this.current.get("image") &&
            -1 === this.current.get("image").src.indexOf(b) &&
            this.playerNode.attr("poster", this.current.get("image").src),
          (a = this.current.get("dimensions").resized),
          this.playerNode.attr(a))
    ...
    renderTracks: function () {
      ...
      this.tracks.each(function (a) {
        b.data.images || a.set("image", !1),
          a.set("artists", b.data.artists),
          a.set("index", !!b.data.tracknumbers && c),
          d.append(b.itemTemplate(a.toJSON())),
          (c += 1);
      }),
        this.$el.append(d),
    ...
    clickTrack: function (a) {
      a.preventDefault(),
        (this.index = this.$(".wp-playlist-item").index(a.currentTarget)),
        this.setCurrent();
    },
    ended: function () {
    ...
    loadCurrent: function () {
      var a =
          ...
          this.playerNode.attr("src").split(".").pop(),
  ...
  (window.wp.playlist = { initialize: d }),
    a(document).ready(d),
    (window.WPPlaylistView = e);
})(jQuery, _, Backbone);
