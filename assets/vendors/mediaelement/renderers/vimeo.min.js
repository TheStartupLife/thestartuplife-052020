          ...
          i = {
            ...
            create: function (e, t, n) {
              var i = [],
                ...
                f = "";
              (a.options = t),
                (a.id = e.id + "_" + t.prefix),
                (a.mediaElement = e);
              for (
                var v = function (t, n) {
                    var r = mejs.Utils.createEvent("error", n);
                    (r.message = t.name + ": " + t.message), e.dispatchEvent(r);
                  },
                      ...
                      if (null !== m)
                        switch (t) {
                          case "src":
                            ...
                            m.loadVideo(l)
                              .then(function () {
                                e.originalNode.autoplay && m.play();
                              })
                              .catch(function (e) {
                                v(e, a);
                              });
              ...
              for (
                var E = mejs.html5media.methods, U = 0, j = E.length;
                U < j;
                U++
              )
                !(function (e) {
              ...
              window["__ready__" + a.id] = function (t) {
                if (((e.vimeoPlayer = m = t), i.length))
                  for (var n = 0, r = i.length; n < r; n++) {
                    ...
                    if ("set" === c.type) {
                      ...
                      a["set" + h](c.value);
                    } else "call" === c.type && a[c.methodName]();
                  }
                e.originalNode.muted && (m.setVolume(0), (s = 0));
                for (
                  var y = document.getElementById(a.id),
                    g = void 0,
                    E = 0,
                    U = (g = ["mouseover", "mouseout"]).length;
                  E < U;
                  E++
                )
                  y.addEventListener(
                ...
                for (
                  ...
                  var w = mejs.Utils.createEvent(g[j], a);
                  e.dispatchEvent(w);
                }
              };
              var b = e.originalNode.height,
              ...
              return (
                ...
                (a.hide = function () {
                  a.pause(), m && (N.style.display = "none");
                }),
