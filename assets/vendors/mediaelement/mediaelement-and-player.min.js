        ...
        var r =
          ...
          p = function e(t, n, o) {
            ...
            if (null !== o) E = o;
              ...
              switch (
                ((E = []), m.mediaElement.originalNode.nodeName.toLowerCase())
              ) {
                case "iframe":
                  E.push({
                    type: "",
          ...
          Object.assign(l.default.prototype, {
            ...
            enterFullScreen: function () {
              ...
              if (
                ...
                for (
                  var l = e.getElement(e.layers).children, p = l.length, m = 0;
                  m < p;
                  m++
                )
            ...
            exitFullScreen: function () {
              ...
              if (
                ...
                for (
                  var a = e.getElement(e.layers).children, s = a.length, l = 0;
                  l < s;
                  l++
                )
                ...
                if (r.options.toggleCaptionsButtonWhenOnlyOne && 1 === m)
                  ...
                  for (
                    var S = e.captionsButton.querySelectorAll(
                      ...
                      x = e.captionsButton.querySelectorAll(
                        "input[type=radio]"
                      ),
                      w = 0,
                      P = E.length;
            ...
            a(e, [
                ...
                value: function () {
                  ...
                  if (
                    ...
                    e
                      ...
                      (e.layers = e
                        .getElement(e.container)
                        .querySelector("." + e.options.classPrefix + "layers"));
                    var S = e.isVideo ? "video" : "audio",
                      x = S.substring(0, 1).toUpperCase() + S.substring(1);
                    e.options[S + "Width"] > 0 ||
                    e.options[S + "Width"].toString().indexOf("%") > -1
                      ...
                      e.options[S + "Height"] > 0 ||
                      e.options[S + "Height"].toString().indexOf("%") > -1
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    for (
                      var c = e.getElement(e.layers).children,
                        f = 0,
                        m = c.length;
                      f < m;
                      f++
                ...
                value: function () {
                  ...
                  if (g.visible(e.getElement(e.container)))
                    if (e.rail && g.visible(e.rail)) {
                      ...
                      for (
                        var u = e.getElement(e.controls).children,
                          c = 0,
                          f = 0,
                          p = u.length;
                        f < p;
              ...
              },
              {
                ...
                value: function (e, t, n, o) {
                  for (
                    var i = this, r = 0, a = i.options.features.length;
                    r < a;
                    r++
                  ) {
            ...
            create: function (e, t, n) {
              ...
              if (
                ((r.default["__ready__" + d] = function (n) {
                  e.dashPlayer = m = n;
                  for (
                    var o = dashjs.MediaPlayer.events, r = 0, s = y.length;
                    r < s;
                    r++
                  )
                    !(function (e) {
                ...
                o[e] = function () {
                  if (i)
                    if (null !== o.flashApi) {
                      ...
                      o.flashApiStack.push({ type: "call", methodName: e });
                };
              })(v[g]);
        ...
        var i =
          ...
          p = {
            ...
            create: function (e, t, n) {
              ...
              return (
                e.dispatchEvent(x),
                e.promises.push(f.load({ options: b, configs: S, id: d })),
                u
              );
            },
          };
        ...
        var i = o(e(3)),
          ...
          f = {
            ...
            create: function (e, t, n) {
              ...
              return (
                (x || e.originalNode.hasAttribute("playsinline")) &&
                  (C.playerVars.playsinline = 1),
      ...
      function (e, t, n) {
        ...
        function i(e) {
          ...
          return (
            ...
            n &&
              (C +=
                (h = (h = (v % l).toFixed(0)) <= 0 ? 0 : h) < 10 && b.f
                  ? c + "0" + h
                  : "" + c + h),
            C
          );
