  ...
  t("form", ".contact-form ").submit(function (r) {
    ...
    if (
      (t(e)
        ...
        .each(function () {
          t(this).css("border-color", ""),
            t.trim(t(this).val()) ||
              (t(this).css("border-color", "red"), (s = !1));
          var r = /^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/;
          "email" != t(this).attr("type") ||
            r.test(t.trim(t(this).val())) ||
            (t(this).css("border-color", "red"), (s = !1));
        })
        .keyup(function () {
          t(this).css("border-color", "");
      ...
      t.ajax({ url: a, type: c, dataType: "json", data: n }).done(function (r) {
        "error" == r.type
          ? (i = '<p class="form-message form-error">' + r.text + "</p>")
          : (t(e)[0].reset(),
            (i = '<p class="form-message form-success">' + r.text + "</p>")),
          o.removeClass("hidden").html(i),
          setTimeout(function () {
            o.addClass("hidden").html("");
          }, 7e3);
      });
    }
  });
