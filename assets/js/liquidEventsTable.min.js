...
!(function ($, e, t, i) {
        ...
        _createClass(e, [
          {
            ...
            value: function e() {
              ...
              (this.$element = $(this.element)),
                (this.$cells = $(".liquid-st-cell", this.element)),
                (this.days = []),
                (this.times = []),
          ...
          },
          {
            ...
            value: function e() {
              var t = this,
                i = $(
                  '<div class="liquid-st-row liquid-st-row-days" />'
                ).appendTo(this.element);
              this.createCells("liquid-st-day", "", i),
                $.each(this.days, function (e, n) {
                  t.createCells("liquid-st-day", n, i);
                }),
                $.each(this.times, function (e, i) {
                  var n = $('<div class="liquid-st-row" />').appendTo(
                    t.$element
                  );
                  n.attr("data-time", i),
                    t.createCells("liquid-st-time", i, n),
                    t.appendScheduleCells(n, i);
                });
            },
          },
          {
              ...
              $.each(this.days, function (e, a) {
                ...
                $.each(
                  ...
                  function (i, l) {
                    ...
                    u.day == n.days[e] &&
                      (s.attr("data-day", a),
                      s.attr("data-time", u.time),
                      s.attr("data-category", u.category),
                      $(
                        "<strong>" +
                          u.name +
                          "</strong><span>" +
          ...
          },
          {
            ...
            value: function e(t, i) {
              t.append(
                '<div class="liquid-st-cell-details"><div class="cell-details-head"><h5>' +
                  i.name +
                  "</h5><span>" +
                  i.info +
                  '</span></div><div class="cell-details-body"><p>' +
                  i.description +
                  '</p><a href="' +
                  i.buttonLink +
                  '" class="btn btn-xsm btn-naked text-uppercase"><span><span class="btn-txt">' +
                  i.buttonText +
                  "</span></span></a></div></div>"
              );
            },
            ...
            value: function e() {
              ...
              $.each(n, function (e, n) {
                var a = $(n),
                  ...
                  o = u.outerHeight(),
                  d = u.position();
                s + r.left + c + d.left >= t && a.addClass("cell-details-left"),
                  l + r.top + o + d.top >= i && a.addClass("cell-details-top");
              });
            },
          },
        ]),
  ...
  $.fn[n] = function (e) {
    return this.each(function () {
      ...
      $.data(this, "plugin_" + n) ||
        $.data(this, "plugin_" + n, new s(this, t));
    });
  };
...
!(function ($, e, t, i) {
        ...
        _createClass(e, [
          {
            key: "init",
            value: function e() {
              (this.filterElement = this.options.filterID),
                (this.cells = $(".liquid-st-cell", this.element).not(
                  ".liquid-st-day, .liquid-st-time"
                )),
                $(this.filterElement).selectmenu(),
                $(this.filterElement).on(
                  "selectmenuselect",
                  this.getFilterItems.bind(this)
                );
            },
          },
          {
  ...
  $.fn[n] = function (e) {
    return this.each(function () {
      ...
      t && (i = $.extend(!0, {}, e, t)),
        $.data(this, "plugin_" + n) ||
          $.data(this, "plugin_" + n, new s(this, i));
    });
  };
})(jQuery, window, document),
  jQuery(document).ready(function ($) {
        ...
        _createClass(t, [
          {
            ...
            value: function e() {
              var t = this.options;
              (this.rows = $(t.rowSelector, this.element)),
                (this.columns = $(t.columnSelector, this.element)),
          ...
          },
          {
            ...
            value: function e() {
              var t = this.options,
                i = [];
              return (
                $.each(this.rows, function (e) {
                  var n = $(this).find(t.columnSelector);
                  $.each(n, function (t, a) {
                    var s = Math.abs(
                      n.length - Math.max(e, t) - (n.length + 1)
                    );
                    i.push(s);
                  });
                }),
              ...
              new IntersectionObserver(
                function (e, i) {
                  e.forEach(function (e) {
                    e.isIntersecting &&
                      (t.animateColumns(), i.unobserve(e.target));
                  });
                },
                { threshold: i }
